...
A colleague suggests using [version control](https://swcarpentry.github.io/git-novice/reference.html#version-control) to manage their work. Version control is better than mailing files back and forth:
...
So read pre-course material and install tools needed.